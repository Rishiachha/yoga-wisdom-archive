...
import heroImage from "@/assets/med-hero-sunrise.jpg";
  ...
  return (
    <section ref={ref} className="relative h-svh min-h-[36rem] overflow-hidden bg-forest">
      <motion.div className="absolute inset-0" style={{ y: imageY }}>
        <img
          src={heroImage}
          alt="A solitary figure seated in meditation on a rock above misty Himalayan ridges at sunrise"
          width={1920}
          height={1088}
      ...
      >
        ...
        >
          ...
          <br className="hidden sm:block" /> attention inward.
        </motion.h1>
        ...
        >
          A journey through awareness, silence and inner discovery.
        </motion.p>
        ...
        >
          ...
          <p lang="sa" className="mt-10 font-display text-3xl text-parchment sm:text-4xl">
            ध्यानम्
          </p>
          <p className="mt-4 max-w-md text-xs italic leading-relaxed text-parchment/65 sm:text-sm">
            Meditation, contemplation and sustained awareness.
          </p>
        </motion.div>
